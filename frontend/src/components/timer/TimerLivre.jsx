...
export default function TimerLivre() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 max-w-lg mx-auto py-4">
      ...
      {toast && (
        <div
          className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2.5 rounded-xl px-5 py-3 text-sm font-medium shadow-xl backdrop-blur-sm transition-all duration-300 animate-[slideUp_0.3s_ease-out] ${toast.tipo === "sucesso"
