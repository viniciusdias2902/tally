...
export default function CardAtividade({ atividade, onEditar, onArquivar, onDeletar }) {
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-border bg-bg-elevated p-4 shadow-sm transition-all duration-150 hover:shadow-md">
