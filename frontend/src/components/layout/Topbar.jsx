  ...
  return (
    <header data-tour="topbar" className="sticky top-0 z-30 bg-bg-primary/80 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4 px-4 py-3 lg:gap-6 lg:px-6">
        ...
        <a
          href={URL_DO_MEU_FORMS}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Avalie o App"
          title="Avalie o App"
          className="p-2 rounded-xl text-text-secondary hover:bg-bg-secondary hover:text-accent transition-all duration-150"
        >
          <MessageBubbleIcon />
        </a>
        ...
        <div className="md:hidden animate-fade-slide-in border-t border-border">
          <div className="flex flex-col gap-1 px-4 pb-4 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium text-text-secondary hover:bg-bg-secondary hover:text-accent transition-all duration-150"
            >
              <MessageBubbleIcon />
              Avalie o App
            </a>
