...
- [ ] `feat(dashboard.repository): adiciona somarSegundosPorDia (raw SQL)`
...
- [ ] `feat(dashboard.repository): adiciona somarPorPastaDoUsuario`
...
- [ ] `test(dashboard.service): cobre obterDistribuicao (3 escopos)`
...
- [ ] `feat(api/dashboard): adiciona heatmap()`
...
- [ ] `feat(components/dashboard): adiciona useTemaGrafico (lê CSS vars do tema)`
